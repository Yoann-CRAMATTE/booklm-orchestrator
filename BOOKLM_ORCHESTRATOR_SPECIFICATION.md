...
## 12. NOTES POUR LA COCRÉATION

Ce skill est en **cocréation avec Yoann CRAMATTE** (Pôle Relations Usagers, DEE-GDU, Grand Belfort).

**Objectif** : Créer un outil réellement utile pour structurer n'importe quel cours vers n'importe quel format pédagogique — particulièrement BookLM, mais extensible.

**Principe** : Aucun résumé superflu, aucune pédagogie creuse. Juste de l'intelligence structurelle et pédagogique appliquée.

**Approche de création** : On ne crée pas BookLM-Orchestrator dans le vide. On s'appuie sur les patterns et les pratiques déjà validées d'autres skills existants, on optimise pour l'audio (TTS), on valide la pédagogie.

---

*Dernière mise à jour : juin 2026*
*Statut : Spécification en cours — prête pour démarrage Claude Code*
